      ...
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Real-time glimpse into what I&apos;m listening to and what I&apos;m
            coding.
          </p>
        </div>

        <div
          className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in slide-in-from-bottom-8 fade-in duration-500 delay-200"
          style={{ animationFillMode: "both" }}
        >
          <SpotifyNowPlaying />
          <WakaTimeStats />
        ...
        <div
          className="animate-in slide-in-from-bottom-8 fade-in duration-500 delay-300"
          style={{ animationFillMode: "both" }}
        >
          <GitHubHeatmap />
        </div>
